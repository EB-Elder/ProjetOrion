...
public class ScrollRectGPScript : ScrollRect, /*IMoveHandler,*/ IPointerClickHandler
{
    ...
    void Update()
    {
        xSpeed += Input.GetAxis("LeftJoystickX") * (Mathf.Abs(xSpeed) + 0.1f);
        ySpeed += -Input.GetAxis("LeftJoystickY") * (Mathf.Abs(ySpeed) + 0.1f);
